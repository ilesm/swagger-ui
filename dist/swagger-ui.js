...
function program11(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + " operation' id='";
  if (helper = helpers.resourceName) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.resourceName); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "_";
